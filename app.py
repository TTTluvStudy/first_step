...
def get_conversation_chain(vectorstore):
    #Temperature 不要是0就可以
    # 假设HuggingFaceEndpoint的构造函数允许直接传递temperature参数
    llm = HuggingFaceEndpoint(repo_id="CohereForAI/c4ai-command-r-plus", temperature=0.2, model_kwargs={"max_length":512})
    # 初始化内存
